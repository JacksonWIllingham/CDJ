...
public class MessageListenerExample extends ListenerAdapter
{
    ...
    public void onMessageReceived(MessageReceivedEvent event)
    {
        ...
        long responseNumber = event.getResponseNumber();//The amount of discord.properties events that JDA has received since the last reconnect.
        ...
        if (msg.equals("!ping"))
        {
            ...
            // By calling queue(), we send the Request to the Requester which will send it to discord.properties. Using queue() or any
